#Create a new project for this, click on the ice cube in the top right corner

#Number 1, create a new file to download the exam
...
A_states <- subset(df, grepl("^A", Province_State))
  ...
  #Selecting rows where the state starts with “A” is tricky (you can use the grepl() 
   #function or just a vector of those states if you prefer)
